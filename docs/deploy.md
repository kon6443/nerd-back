...
> **경계**: 여기는 *어떻게 배포하고 운영하는가*. 코드 규약은 [`conventions/code-patterns.md`](conventions/code-patterns.md), 금지·함정은 [`../CLAUDE.md`](../CLAUDE.md), 결정 근거는 [`tasks/tasks-backend-skeleton.md`](tasks/tasks-backend-skeleton.md).
...
배포 구성이 코드에 거는 제약이다. 코드를 쓸 때의 상세는 [`conventions/code-patterns.md`](conventions/code-patterns.md) §6·§8.

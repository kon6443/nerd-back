...
```bash
apps/back/scripts/db-tunnel.sh fs-01 3307     # 터미널 1 — 열어둔 채로. 노트북에 MySQL 이 없으면 포트 생략(3306)
...
apps/back/scripts/db-tunnel.sh fs-01 3307             # 다른 터미널에서 유지. .env.migration 의 DB_PORT 를 같은 포트로
